# Etude sur la sous-alimentation
...
- **Objectif** : Explorer et analyser des données en utilisant des langages et outils métiers

**Compétences** :
- Analyse de données avec un notebook Python
